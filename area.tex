...
(То, что всякому многоугольнику можно приписать значение площади так, чтобы площадь частей равнялось площади целого --- это вовсе не простая теорема; в школьных учебниках геометрии её обычно принимают без доказательства.
...
Заметим, что равенства достигаются только если углы $\angle B$, $\angle C$, $\angle D$ и $\angle A$ прямые --- это нам скоро пригодиться.
...
Если же достигается равенство, то $AB = a$, $BC\z= b$, $CD= c$ и $DA= d$.
